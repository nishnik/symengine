...
{
    GaloisFieldDict f = GaloisFieldDict::from_vec({-1_z, 0_z, 0_z, 0_z, 1_z}, 625_z);
    ...
    REQUIRE(std::find(out.begin(), out.end(), UIntDict::from_vec({-1_z,
    1_z}))
            != out.end());
    REQUIRE(std::find(out.begin(), out.end(), UIntDict::from_vec({1_z, 1_z}))
            != out.end());
    REQUIRE(std::find(out.begin(), out.end(), UIntDict::from_vec({-182_z,
    1_z}))
            != out.end());
    REQUIRE(std::find(out.begin(), out.end(), UIntDict::from_vec({182_z,
    1_z}))
