...
public:
    ...
    gf_factor() const;
    static void zz_hensel_step(const integer_class &m, const GaloisFieldDict &ff,
                               GaloisFieldDict &g, GaloisFieldDict &h,
                               GaloisFieldDict &s, GaloisFieldDict &t,
                               const Ptr<GaloisFieldDict> &G,
                               const Ptr<GaloisFieldDict> &H,
                               const Ptr<GaloisFieldDict> &S,
                               const Ptr<GaloisFieldDict> &T);
    static std::vector<UIntDict> zz_hensel_lift(
        ...
        unsigned int l);
    std::vector<UIntDict> zz_hensel_lift(
        const UIntDict &f, const integer_class &p,
